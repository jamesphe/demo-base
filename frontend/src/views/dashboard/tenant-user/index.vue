        ...
        <div class="main-content">
          ...
          <div class="task-section">
            <div class="section-header">
              <h3><i class="el-icon-s-claim" /> 我的待办</h3>
            ...
            <el-card shadow="hover">
              <div v-for="task in myTasks" :key="task.id" class="task-item">
                ...
                <span class="task-time"><i class="el-icon-time" /> {{ task.deadline }}</span>
          ...
          <div class="interview-section">
            <div class="section-header">
              <h3><i class="el-icon-s-cooperation" /> 近期面试安排</h3>
              ...
              >
                <el-card shadow="hover" class="interview-card">
                  <div class="interview-info">
                    ...
                    <div v-if="interview.location" class="interview-location">
                      <i class="el-icon-location" /> {{ interview.location }}
                    </div>
        ...
        <div class="side-content">
          ...
          <el-card class="statistics-card" shadow="hover">
            <div class="card-header">
              <h4><i class="el-icon-data-analysis" /> 本月工作统计</h4>
            ...
            <div class="stat-progress">
              <div class="progress-item">
                ...
                <el-progress :percentage="monthlyStats.completionRate" :color="progressColor" />
              </div>
            </div>
          </el-card>
          ...
          <el-card class="quick-actions-card" shadow="hover">
            <div class="card-header">
              <h4><i class="el-icon-s-tools" /> 快捷操作</h4>
            </div>
          ...
          <el-card class="calendar-card" shadow="hover">
            <div class="card-header">
              <h4><i class="el-icon-date" /> 日程提醒</h4>
            </div>
            <div class="upcoming-events">
              <div v-for="event in upcomingEvents" :key="event.id" class="event-item">
                ...
                <div class="event-content">
                  ...
                  <div class="event-time"><i class="el-icon-time" /> {{ event.time }}</div>
                </div>
              </div>
            </div>
          </el-card>
